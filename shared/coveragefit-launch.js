(function (window, document) {
  ...
  function buildUrl(options) {
    ...
    // Launch the animated transition route directly. This avoids relying on the
    // CoverageFit Home page to receive the handoff and perform a second redirect.
    // The transition controller returns the visitor to the intended Home journey.
