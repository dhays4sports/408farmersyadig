...
test('direct score entry builds canonical CoverageFit URL', () => {
  ...
  const dest = env.window.CoverageFitLauncher.buildUrl({entry:'score', assessment:'home', extra:{launch_surface:'home_protection_score'}});
  const u = new URL(dest);
  assert.equal(u.origin + u.pathname, 'https://coveragefit.com/home/');
